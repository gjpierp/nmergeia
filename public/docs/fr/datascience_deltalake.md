...
La presente guía detalla la implementación profesional de **Delta Lake Architecture** en su **Niveau Initial**.
...
```mermaid
flowchart TD
    A["Client / Application NMerge"] -->|Demande de traitement| B["Delta Lake Architecture Engine (Niveau Initial)"]
