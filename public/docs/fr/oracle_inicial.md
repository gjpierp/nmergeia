...
- **Processus d'Arrière-plan Principales:**
...
## 🏗️ 2. Architecture Mémoire SGA/PGA y Processus d'Arrière-plan
...
flowchart TD
    ...
    subgraph BackgroundProcesses ["Processus d'Arrière-plan (Oracle Background Swarm)"]
