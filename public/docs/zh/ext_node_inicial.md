...
## Próximos Pasos
Hemos entendido cómo respira Node.js. En el **基础级**, dejaremos la teoría y crearemos nuestro primer servidor HTTP utilizando el framework que gobierna el 90% del mercado: Express.js.
