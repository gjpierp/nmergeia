...
```mermaid
flowchart TD
    A["Cliente / Aplicación NMerge"] -->|Petición de Procesamiento| B["Polars Rust & SIMD Engine (Nivel Experto)"]
...
```python
# =====================================================================
# NMerge IA - Módulo de Especialidad: Polars Rust & SIMD (Experto)
...
```bash
# Ejecutar verificación formal para Polars Rust & SIMD (experto)
npm run test -- --grep="polars_experto"
```
