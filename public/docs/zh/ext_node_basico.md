...
Ahora sabes crear las rutas, pero meter todo en un solo archivo `index.js` crea código espagueti. En el **中级**, aprenderemos a estructurar la arquitectura por Capas (Routes, Controllers, Services) y el concepto más vital de Express: Los Middlewares.
