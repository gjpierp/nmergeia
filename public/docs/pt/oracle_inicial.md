...
- **Processos de Segundo Plano Principales:**
...
## 🏗️ 2. Arquitetura de Memória SGA/PGA y Processos de Segundo Plano
...
flowchart TD
    ...
    subgraph BackgroundProcesses ["Processos de Segundo Plano (Oracle Background Swarm)"]
