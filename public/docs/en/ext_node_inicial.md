...
## Próximos Pasos
Hemos entendido cómo respira Node.js. En el **Basic Level**, dejaremos la teoría y crearemos nuestro primer servidor HTTP utilizando el framework que gobierna el 90% del mercado: Express.js.
