...
## Próximos Pasos
Hemos entendido que Serverless es ejecución por eventos (Event-Driven Computing). En el **基本レベル**, exploraremos profundamente AWS Lambda, sus restricciones de tiempo, y el concepto del "Cold Start" (Arranque en frío).
