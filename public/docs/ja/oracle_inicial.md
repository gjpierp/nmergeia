...
## 🏗️ 2. メモリアーキテクチャ SGA/PGA y バックグラウンドプロセス
...
flowchart TD
    ...
    subgraph BackgroundProcesses ["バックグラウンドプロセス (Oracle Background Swarm)"]
