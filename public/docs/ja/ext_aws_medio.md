...
## Próximos Pasos
Crear estos recursos haciendo clics en la consola web de AWS (Click-Ops) es un pecado capital en la industria. En el **上級レベル**, abrazaremos la Infraestructura como Código (IaC) usando Serverless Framework, SAM o Terraform.
