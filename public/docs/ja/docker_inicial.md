...
## Próximos Pasos
Hemos dominado el consumo de imágenes preexistentes. En el **基本レベル**, dejaremos de ser consumidores para convertirnos en creadores: aprenderemos a escribir nuestro propio `Dockerfile` y empacar nuestra propia aplicación Node.js/Python.
