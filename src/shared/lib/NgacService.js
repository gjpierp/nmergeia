...
export const NgacService = {
  ...
  getDynamicMenu: async (userRoles = [], isLoggedIn = false) => {
    ...
    try {
      ...
      // Asegurar que los menús core estén disponibles y respetar estrictamente la respuesta del motor NGAC
      const coreMenus = ['Landing', 'landing', 'MNU_NMERGE_LANDING', 'Comparar', 'main', 'MNU_NMERGE_MAIN', 'Login', 'Register', 'Privacy', 'Terms', 'Docs', 'Terminal', 'FAQ', 'Historial', 'Filtros'];
      ...
      const hasPremiumAccess = userRoles.includes('ROLE_NMERGEIA_ADMIN') || (userRoles.includes('ROLE_NMERGEIA_REGISTRADO') && isPremium);
      ...
      const baseCodes = ['Landing', 'landing', 'MNU_NMERGE_LANDING', 'Comparar', 'main', 'MNU_NMERGE_MAIN', 'Login', 'Register', 'Privacy', 'Terms', 'Docs', 'Terminal', 'FAQ', 'Historial', 'Filtros'];
  ...
  setupNgacBasePolicies: async () => {
    ...
    try {
      ...
      const allOptions = ['Landing', 'Comparar', 'Login', 'Historial', 'Filtros', 'Register', 'AdBannerTop', 'AdBannerSidebar', 'AdBannerMatrix', 'Privacy', 'Terms', 'Docs', 'FAQ', 'Terminal', 'AdSenseAdmin', ...topics];
      ...
      const guestOptions = ['Landing', 'Comparar', 'Historial', 'Filtros', 'Login', 'Register', 'AdBannerTop', 'AdBannerSidebar', 'AdBannerMatrix', 'Privacy', 'Terms', 'Docs', 'FAQ', ...topicsGuest];
