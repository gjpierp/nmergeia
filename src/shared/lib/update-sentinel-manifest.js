...
console.log("🚀 Sincronizando el Manifiesto de Sentinel-NGAC con los 31 temas y subtemas generados...");

// 1. Escribir routesManifest.js con todos los nodos
...
export const MENU_TREE = [
  ...
  },
  {
    ...
    children: [
      ...
      // 🛡️ Ciberseguridad & Gobernanza Sentinel
      { id: 1230, code: 'MNU_NGAC_GUIDE', label: 'Gobernanza Sentinel-NGAC (Guía Completa)', path: '/temas/ngac', icon: 'security', priority: '0.8', changefreq: 'weekly' },
      ...
      { id: 1252, code: 'MNU_TEMA_12', label: 'Resiliencia Backend & Circuit Breakers', path: '/temas/tema-12-resiliencia-backend', icon: 'shield_heart', priority: '0.7', changefreq: 'monthly' },
...
fs.writeFileSync(routesManifestPath, routesManifestContent, 'utf8');
console.log("✅ routesManifest.js actualizado con las 31 rutas de especialidades.");

// 2. Escribir prerender.js con las 31 rutas físicas HTML
...
console.log("✅ prerender.js actualizado con las 38 rutas físicas.");
