...
function App() {
  ...
  const renderTabContent = () => {
    ...
    if (activeTab === 'crypto-pki' || activeTab.includes('crypto/pki') || activeTab.includes('pki')) return <GenericTopicPage topicId="crypto_pki" title="PKI, TLS 1.3 & Criptografía Post-Cuántica" singleFile="crypto_pki.md" appLanguage={appLanguage} />;
    if (activeTab === 'security-zerotrust' || activeTab.includes('security/zerotrust') || activeTab.includes('zerotrust')) return <GenericTopicPage topicId="security_zerotrust" title="Zero-Trust Architecture & Service Mesh" singleFile="security_zerotrust.md" appLanguage={appLanguage} />;
