...
const PrivacyPage = React.lazy(() => import('./features/landing/PrivacyPage.jsx').then(m => ({ default: m.PrivacyPage })));
const TermsPage = React.lazy(() => import('./features/landing/TermsPage.jsx').then(m => ({ default: m.TermsPage })));
    ...
    <main className="app-container">
      ...
      <footer className="app-footer">
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px', flexWrap: 'wrap' }}>
          <span>&copy; 2026 Todos los derechos reservados a StackUpIA.</span>
          <div style={{ display: 'flex', gap: '15px', borderLeft: '1px solid var(--border-color)', paddingLeft: '15px', fontSize: '0.85rem' }}>
            <span style={{ cursor: 'pointer', color: 'var(--text-secondary)' }} onClick={() => setActiveTab('privacy')} onMouseEnter={(e) => e.target.style.color='var(--accent-primary)'} onMouseLeave={(e) => e.target.style.color='var(--text-secondary)'}>Privacidad</span>
            <span style={{ cursor: 'pointer', color: 'var(--text-secondary)' }} onClick={() => setActiveTab('terms')} onMouseEnter={(e) => e.target.style.color='var(--accent-primary)'} onMouseLeave={(e) => e.target.style.color='var(--text-secondary)'}>T̩rminos</span>
            <span style={{ cursor: 'pointer', color: 'var(--text-secondary)' }} onClick={() => setActiveTab('cookies')} onMouseEnter={(e) => e.target.style.color='var(--accent-primary)'} onMouseLeave={(e) => e.target.style.color='var(--text-secondary)'}>Cookies</span>
            <span style={{ cursor: 'pointer', color: 'var(--text-secondary)' }} onClick={() => setActiveTab('legal-notice')} onMouseEnter={(e) => e.target.style.color='var(--accent-primary)'} onMouseLeave={(e) => e.target.style.color='var(--text-secondary)'}>Aviso Legal</span>
          </div>
        </div>
