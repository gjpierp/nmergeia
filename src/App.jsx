...
function App() {
  ...
  const renderTabContent = () => {
    ...
    if (activeTab === 'tema-17-kubernetes' || activeTab.includes('kubernetes') || activeTab.includes('tema-17')) return <GenericTopicPage topicId="docker" title="Kubernetes & Orquestación" singleFile="tema_17_kubernetes_orquestacion.md" appLanguage={appLanguage} />;
