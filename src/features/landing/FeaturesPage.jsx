        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '25px', marginBottom: '40px' }}>
          ...
          <div className="section-card" style={{ padding: '25px', background: 'var(--bg-secondary)', borderRadius: '12px', border: '1px solid var(--border-light)' }}>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: '1.6', margin: 0 }}>
              Arrastra cualquier directorio o conjunto de archivos directamente desde tu explorador nativo hacia los slots de comparación. NMergeIA resolverá de manera jerárquica y en milisegundos toda la topología de archivos para comenzar la inspección sin demoras.
            </p>
          </div>
          ...
          <div className="section-card" style={{ padding: '25px', background: 'var(--bg-secondary)', borderRadius: '12px', border: '1px solid var(--border-light)' }}>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: '1.6', margin: 0 }}>
              La resolución de conflictos nunca fue tan sencilla. En lugar de copiar bloques a ciegas, NMergeIA analiza semánticamente las diferencias y te propone una fusión inteligente y limpia del código, reduciendo la fricción en integraciones complejas.
            </p>
          </div>
        </div>
