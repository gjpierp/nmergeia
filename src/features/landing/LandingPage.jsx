...
export const LandingPage = () => {
  ...
  return (
    <div style={{
      ...
      {/* Hero Header */}
      <div style={{ maxWidth: '850px', margin: '0 auto 40px auto', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <h1 style={{
          ...
          NMerge IA: Plataforma Profesional de Comparación y Fusión Semántica de Código
        </h1>
        ...
        {/* CTA Buttons with explicit HTML anchor tags for crawlers */}
      ...
      {/* Deep Technical Content Container (>1,400 words for AdSense & EEAT) */}
      <div style={{
        maxWidth: '1000px',
        width: '100%',
        textAlign: 'left',
        ...
        <section style={{ marginBottom: '40px' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <section style={{ marginBottom: '40px' }}>
          ...
          <ol style={{ paddingLeft: '24px' }}>
            ...
            <li><strong>Filtrado y Exclusiones Inteligentes:</strong> Aplica patrones de exclusión mediante máscaras de expresiones regulares (`.git`, `node_modules`, `dist`, `coverage`) para enfocarte únicamente en el código fuente de valor.</li>
        ...
        <section style={{ marginBottom: '40px' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '16px' }}>
        ...
        {/* Section 7: FAQ Section for UX and EEAT */}
        <section style={{ marginBottom: '40px' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        {/* Section 8: Comprehensive HTML Links & Sitemap Index for Crawlers & AdSense */}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginTop: '20px' }}>
            ...
            <div style={{ background: 'var(--bg-tertiary)', padding: '20px', borderRadius: '10px', border: '1px solid var(--border-color)' }}>
              ...
              <ul style={{ paddingLeft: '20px', margin: 0 }}>
                ...
                <li><a href="/cookie-policy" onClick={(e) => handleNav('cookie-policy', '/cookie-policy', e)} style={{ color: 'var(--accent-primary)' }}>Política de Cookies GDPR</a></li>
